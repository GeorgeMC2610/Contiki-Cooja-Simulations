...
// in this file, we're trying to display the humidity in the HTML page of the sky-websense mote.
// we added the get_humid() function to display it.
// and made sure to make one more reading in the HTML code.
